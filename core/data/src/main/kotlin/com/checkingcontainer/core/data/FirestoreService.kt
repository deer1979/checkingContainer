...
class FirestoreService @Inject constructor(
    ...
    private fun DocumentSnapshot.toEstimadoEntity(): EstimadoEntity? {
        ...
        return EstimadoEntity(
            ...
            sitioClienteId = safeLong("sitioClienteId"),
            sitioNombre = getString("sitioNombre") ?: "",
            ordenTrabajo = getString("ordenTrabajo") ?: "",
            ...
            observacionesFotos = getString("observacionesFotos") ?: "[]",
...
private fun EstimadoEntity.toFirestoreMap(): Map<String, Any?> = mapOf(
    ...
    "sitioClienteId" to sitioClienteId,
    "sitioNombre"   to sitioNombre,
    "ordenTrabajo"  to ordenTrabajo,
    "location"      to location,
    "technicianId"  to technicianId,
    "technicianName" to technicianName,
    "createdAt"     to createdAt,
    ...
    "observacionesFotos" to observacionesFotos,
